...
{
	Sprite::Sprite() :  
						image(NULL),imageLoaded(false),position(Vector2(0.0f,0.0f)),
						state(0),width(1),height(1),curFrame(0),totalFrames(1),animDir(1),animColumns(1),
						frameStart(0),frameTimer(0),animStartX(0),animStartY(0),faceAngle(0.0f),
						rotation(0.0f),scaling(1.0f),colour(0xFFFFFFFF),collidable(true)
